...
namespace Smidge.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public ActionResult<string> Login()
        {
            ...
            var email = jwtToken.Claims.FirstOrDefault(claim => claim.Type == "email") ?? jwtToken.Claims.First(claim => claim.Type == "preferred_username");
            ...
            if (!allowedEmails.Contains(emailstr))
            {
                return Unauthorized();
            }
