    ...
    <>
      ...
      <div className="about-smidge about-section">
        ...
        <Row className="about-section">
          <div className="about-regular-text">
            SMIDGE aims to gain a comprehensive understanding of the factors
            contributing to the rise of extremist narratives among the
            middle-aged individuals in Europe and their impact on mainstream
            worldviews, discourses, and policies. To achieve this, the project
            will take a multi-disciplinary approach, incorporating legal,
            psychological, technical, sociological, political, and
            anthropological perspectives.
          </div>
          <div className="about-regular-text">
            One of SMIDGE's primary objectives is to produce and disseminate
            alternative narratives in the form of counter-videos, memes, and
            other micro-content. To ensure that this content is effective, the
            project will employ an innovative approach to its creation, drawing
            on previous research and engaging in new empirical work. The goal is
            to promote reflexivity among target stakeholders, including those
            who are vulnerable to extremist material and those tasked with
            addressing the issues.
          </div>
          <div>
            In a new, responsible research and innovation (RRI) based
          ...
          <div>
            ...
            ensure adherence to the highest ethical and quality standards. The
            resulting counter-content, educational tools, and policy
            recommendations will promote first and second-order reflexivity and
            contribute to the fight against extremist narratives.
          </div>
          <div>
            The outputs from SMIDGE will provide evidence-based content, tools
            and resources that will assist in countering extremist narratives
            from various perspectives. This will provide a better understanding
            of the specificities and characteristics of middle-aged individuals
            and their vulnerability to online extremism, as well as
          ...
          <div>
            ...
            resource, SMIDGE aims to increase awareness and understanding of the
            factors contributing to the rise of extremist narratives, and
            promote the development of effective counter-measures.
          </div>
        </Row>
      </div>
    </>
